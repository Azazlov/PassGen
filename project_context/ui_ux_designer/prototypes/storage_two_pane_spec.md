# 📐 Storage Two-Pane Layout Specification

**Version:** 1.0
**Date:** 2026-03-08
**Task:** IMPROVEMENT_PLAN_v0.6.0 — Задача 1.2
**ТЗ Section:** 6.3
...
Двухпанельный макет для экрана хранилища паролей с адаптивной компоновкой для разных размеров экрана.
...
**Pattern:** Single pane with bottom navigation

**Characteristics:**
- Full-screen password list
- Search and filter at top
- FAB for adding new password
- Tap item → Detail screen (new page)
...
**Pattern:** Two-pane master-detail
...
### 2.4 Wide Layout (≥ 1200dp)

**Pattern:** Three-pane with permanent sidebar

**Characteristics:**
- NavigationRail (80dp)
- Sidebar/List (280dp) with permanent categories
- Details panel (Expanded) with full details
- All panes visible simultaneously
...
| **Selected Item** | Highlighted with primaryContainer color |
