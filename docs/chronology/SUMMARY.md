...
|---------|----------|
| **Файлов Dart** | 118 |
| **Строк кода (всего)** | ~9,500+ |
| **Строк кода (Domain)** | ~2,500 |
| **Строк кода (Data)** | ~3,500 |
| **Строк кода (Presentation)** | ~3,500 |
| **Средний размер файла** | ~80 строк |
| **Самый большой файл** | ~400 строк (database_schema.dart) |
...
| **Рабочих дней** | 5 дней |
| **Часов работы (оценка)** | ~85 часов |
| **Средняя скорость** | ~1,600 строк/день |

### 4.2 Распределение времени

| Категория | Часов | Процент |
|-----------|-------|---------|
| **Разработка (код)** | 38 | 45% |
| **Документация** | 17 | 20% |
| **Тестирование** | 8 | 10% |
| **DevOps** | 8 | 10% |
| **Планирование** | 8 | 10% |
